...
var scopalAudio = (function(window) {
    ...
    var Recorder = function(source, cfg){
        ...
        this.getBuffer = function(cb) {
            currCallback = cb || scopal.getConfig().callback;
            ...
            fileReader.onload = function(){
                ...
                mp3encoderWorker.onmessage = function(e) {
                    if (e.data.cmd == 'data') {
                        ...
                        if( debug ) console.log("> encoding audio");
        ...
        function sendASRRequest(blob) {
            ...
            $.ajax({ // asynchronous javascript and xml
                ...
                var reg_idx = -1;
                var cur_img_region = scopal.getCurrentImageInfo().regions;
                ...
                for(var i = 0; i < cur_img_region.length; i++ ) {
                    ...
                    if (cur_img_region[i].uid == cur_id) reg_idx = i;
                }
        
                if (reg_idx >= 0) {
                    if (isEmpty(responseData)) {
                        $("#desp-"+cur_id).val('Please speak again...');
                        scopal.getCurrentImageInfo().regions[reg_idx].transcript = '';
                        ...
                        scopal.getCurrentImageInfo().regions[reg_idx].transcript = transcript;
        ...
        function uploadAudio(mp3Data){
            ...
            reader.onload = function(event){
                ...
                formdata.append('name', scopal.getCurrentImageInfo().name);
                formdata.append('dataset', scopal.getCurrentDatasetInfo().folder);
